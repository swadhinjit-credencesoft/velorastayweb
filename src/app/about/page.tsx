...
export const metadata: Metadata = {
  title: "About Us | Vellora Stays",
  description:
    "Discover the story behind Vellora Stays — a premium luxury villa in Pawna Lake, Lonavala. Learn about our mission and commitment to exceptional hospitality.",
  alternates: { canonical: "/about" },
  openGraph: {
    title: "About Us | Vellora Stays",
    description: "Learn about Vellora Stays, our story, and mission.",
    ...
    <>
      ...
      <section className="relative py-20 pt-32">
        <div className="absolute inset-0 z-0">
          <Image src="/heroimg3.jpeg" alt="About Vellora Stays" fill className="object-cover" sizes="100vw" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-gray-300 max-w-2xl mx-auto text-lg">Discover the story behind Vellora Stays.</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-amber-500 text-white text-center">
        <div className="max-w-2xl mx-auto px-4">
          <h2 className="text-3xl font-bold mb-4">Experience the Vellora Stays Difference</h2>
