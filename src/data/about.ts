...
export const ABOUT_MILESTONES: Milestone[] = [
  ...
  },
  {
    ...
    description:
      "Responding to growing demand, Velora Stays expanded its capacity from 3 to 5 luxury villas, adding new villa categories including the Premium 5 BHK and the Grand 7 BHK. The expansion included a renovation of the common areas, the addition of new outdoor activities, and the introduction of enhanced guest experience packages. The property also launched its direct booking platform for a seamless reservation experience.",
  },
  {
    id: "milestone-2025",
    year: "2025",
