...
export const ABOUT_VALUES: AboutValue[] = [
  ...
  },
  {
    ...
    description:
      "The hospitality industry is always evolving, and so are we. At Vellora Stays, we foster a culture of continuous learning and improvement at every level of the organisation. We invest in regular staff training programs, stay current with industry best practices, and actively seek innovative solutions to enhance the guest experience. Our management team conducts monthly reviews of guest feedback, operational metrics, and industry trends to identify opportunities for enhancement. We embrace technology that simplifies processes and improves convenience for our guests, from our streamlined online booking system to our WhatsApp-based guest support. Complacency has no place at Vellora Stays; we are always striving to be better today than we were yesterday.",
...
export const ABOUT_MILESTONES: Milestone[] = [
  ...
  },
  {
    ...
    title: "500th Guest",
    description:
      "Within its first year of operation, Vellora Stays welcomed its 500th guest, a milestone that validated the growing demand for luxury villa experiences near Mumbai and Pune. The property achieved an average guest rating of 5.0 on Google and received its first batch of glowing reviews on MakeMyTrip and Airbnb, establishing a strong foundation for organic growth through word-of-mouth recommendations.",
  },
  {
    id: "milestone-2024",
    year: "2024",
    ...
    description:
      "Responding to growing demand, Vellora Stays expanded its capacity from 3 to 5 luxury villas, adding new villa categories including the Premium 5 BHK and the Grand 7 BHK. The expansion included a renovation of the common areas, the addition of new outdoor activities, and the introduction of enhanced guest experience packages. The property also launched its direct booking platform for a seamless reservation experience.",
  },
  {
    id: "milestone-2025",
    year: "2025",
    title: "100+ Reviews",
    description:
      "Vellora Stays crossed the milestone of 100+ cumulative verified reviews across Google, MakeMyTrip, and Airbnb, with an overall rating of 5.0 stars. The property was recognised as one of the top luxury villa stays near Pawna Lake and received the Guest Satisfaction Award from Airbnb. The team continued to innovate with new villa amenities, curated experiences, and enhanced guest services.",
  },
];
