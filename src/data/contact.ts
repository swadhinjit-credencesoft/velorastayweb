...
export const CONTACT_INFO: ContactInfo[] = [
  ...
  },
  {
    ...
    value: "+91 9324248001",
    href: "https://api.whatsapp.com/send?phone=919324248001&text=This%20is%20an%20Enquiry%20from%3A%20Vellora%20Stays%20Website",
    primary: true,
  },
  {
    label: "Email",
    icon: "lucide:mail",
    value: "info@vellorastays.in",
    href: "mailto:info@vellorastays.in",
    primary: true,
  },
  {
    label: "Address",
    ...
    href: "https://maps.google.com/?q=Vellora+Stays+Pawna+Lake+Lonavala",
  },
  {
    label: "Working Hours",
    icon: "lucide:clock",
...
export const CONTACT_DEPARTMENT: Department[] = [
  {
    ...
    phone: "+91 9324248001",
    description:
      "For any general questions about Vellora Stays, our villa configurations, amenities, or policies, our team is happy to help.",
  },
  {
