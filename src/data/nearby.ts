...
export const NEARBY_ATTRACTIONS: NearbyAttraction[] = [
  ...
  },
  {
    ...
    name: "Tung Fort",
    description:
      "A compact hill fort near Pawna Lake offering a short, rewarding trek with panoramic views of the lake, nearby forts, and the Tungarli valley. Also known as Tung Fort (Kathingad), it is a favourite among sunrise trekkers and campers.",
    image: "/rajmachifort.jpg",
    distance: "12 km",
    travelTime: "12 min drive",
    category: "Trekking",
    highlights: ["Sunrise trek", "Panoramic views", "Camping base", "Lake views"],
    tips: "Best visited at sunrise for clear views. The trek is short but steep — wear sturdy shoes and carry water.",
    mapUrl: "https://maps.google.com/?q=Tung+Fort+Pawna+Lake",
  },
  {
    id: "lion-point",
    slug: "lion-point",
  ...
  },
  {
    ...
    name: "Dinosaur Park",
    description:
      "A mini Jurassic Park experience near Pawna Lake, featuring 30+ life-size animatronic dinosaur figures spread across 6.5 acres. Perfect for families and kids, with dinosaur-themed rides, a selfie museum, mirror maze, and horror house for a fun-filled day out.",
    image: "/images/dianasourpark.png",
    distance: "11 km",
    travelTime: "20 min drive",
    category: "Entertainment",
    highlights: ["Animatronic dinosaurs", "Family fun", "Selfie museum", "Kids friendly"],
    tips: "Open daily from 10:00 AM to 6:00 PM. Book tickets online on weekends to avoid queues.",
    mapUrl: "https://maps.google.com/?q=Dinosaur+Park+Lonavala",
  },
];
