...
export const LOCAL_SEO_PAGES: LocalSeoPage[] = [
  {
    ...
    metaDescription:
      "Looking for a comfortable hotel near New Delhi Railway Station? The Queen's Head â€“ Paharganj offers air-conditioned rooms, free Wi-Fi, a 24-hour front desk and an on-site restaurant.",
    ...
    intro: [
      ...
      "The Queen's Head â€“ Paharganj is located in Chuna Mandi, Paharganj, making it a practical accommodation option for travellers visiting New Delhi for business, leisure, shopping and sightseeing.",
  ...
  },
  {
    ...
    metaDescription:
      "Stay close to Ramakrishna Mission in New Delhi. The Queen's Head â€“ Paharganj is approximately 0.9 km away, with comfortable rooms, Wi-Fi and a 24-hour front desk.",
    eyebrow: "Approx. 0.9 km from Ramakrishna Mission",
    intro: [
      "Ramakrishna Mission is one of the nearby landmarks listed for the property.",
      "The Queen's Head â€“ Paharganj offers a comfortable base just a short distance from Ramakrishna Mission, with air-conditioned rooms, free Wi-Fi and a 24-hour front desk.",
  ...
  },
  {
    ...
    metaDescription:
      "Gurudwara Bangla Sahib is approximately 2.2 km from The Queen's Head â€“ Paharganj. Book a comfortable room with free Wi-Fi and 24-hour front desk assistance.",
    ...
    intro: [
      ...
      "The Queen's Head â€“ Paharganj provides comfortable accommodation approximately 2.2 km away, with air-conditioned rooms, free Wi-Fi and an on-site restaurant.",
  ...
  },
  {
    ...
    metaDescription:
      "Stay near Jantar Mantar and Connaught Place in Central Delhi. The Queen's Head â€“ Paharganj offers comfortable rooms with Wi-Fi, air conditioning and 24-hour assistance.",
    eyebrow: "Central Delhi Location",
    intro: [
      "Jantar Mantar is a major historical and astronomical landmark in Central Delhi.",
      "The Queen's Head â€“ Paharganj offers a convenient base in Paharganj for travellers wanting to explore Central Delhi, including Jantar Mantar, Connaught Place, Gurudwara Bangla Sahib and other attractions.",
  ...
  },
  {
    ...
    metaDescription:
      "Stay near Connaught Place in Central Delhi. The Queen's Head â€“ Paharganj provides a convenient base with comfortable rooms, free Wi-Fi and an on-site restaurant.",
    eyebrow: "Central Delhi Base",
    intro: [
      "The Queen's Head â€“ Paharganj provides a convenient Paharganj base for travellers wanting to explore Central Delhi.",
  ...
  },
  {
    ...
    intro: [
      "The Queen's Head â€“ Paharganj provides practical accommodation for professionals travelling to New Delhi.",
  ...
  },
  {
    ...
    metaDescription:
      "Planning a family trip to Delhi? The Queen's Head â€“ Paharganj offers family-friendly rooms, Wi-Fi, air conditioning, private bathrooms and a central location.",
    eyebrow: "Family-Friendly Stay",
    intro: [
      "Planning a family trip to Delhi?",
      "The Queen's Head â€“ Paharganj offers family-friendly accommodation with air-conditioned rooms, free Wi-Fi, television, private bathrooms and convenient hotel services.",
  ...
  },
  {
    ...
    metaDescription:
      "Delhi International Airport is approximately 15 km from The Queen's Head â€“ Paharganj. A convenient Paharganj base for travellers arriving in or departing from Delhi.",
    ...
    intro: [
      ...
      "The Queen's Head â€“ Paharganj offers a convenient Paharganj location for travellers arriving in or departing from Delhi, with comfortable rooms, free Wi-Fi and a 24-hour front desk.",
    ...
    points: [
      "Delhi International Airport â€” approx. 15 km",
